...
export default class ExpenseForm extends React.Component {
    constructor(props) {
        ...
        //to treat the expense if exists or not
        this.state = {
            description: props.expense ? props.expense.description : "",
            note: props.expense ? props.expense.note : "",
            //Instead of type number, we do this to enforce two max decimals
    ...
    onAmountChange = (e) => {
        ...
        //Only will accept one comma and two decimals
    ...
    onDateChange = (createdAt) => {
        //To prevent the user from deleting the date
        if(createdAt){
